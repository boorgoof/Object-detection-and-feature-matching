...
int main(int argc, const char* argv[]){
    ...
    std::unique_ptr<ObjectDetector> object_detector(new CompositeObjectDetector(cv::xfeatures2d::SIFT::create(), cv::DescriptorMatcher::create(cv::DescriptorMatcher::FLANNBASED)));
